...
import { IconBrain, IconEye, IconMessage, IconGlobe, IconBarChart, IconGraduationCap, IconVideo, IconMapPin } from './Icons';

const services = [
  { icon: IconBrain, title: 'AI & Machine Learning', desc: 'Custom AI models, predictive analytics, and intelligent automation tailored to your business.' },
  { icon: IconEye, title: 'Computer Vision', desc: 'Image recognition, object detection, and visual AI systems for real-world applications.' },
  { icon: IconMessage, title: 'NLP & Chatbots', desc: 'Natural language processing, conversational AI, and smart chatbot development.' },
  { icon: IconGlobe, title: 'Web & Desktop Apps', desc: 'Full-stack web applications and powerful desktop software built with modern tech.' },
  { icon: IconBarChart, title: 'Data Analysis', desc: 'Turn raw data into actionable insights with advanced analytics and visualization.' },
];
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 48, alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}
              ...
              {[
                ...
                >
                  <div style={{
                    width: 42, height: 42, borderRadius: 10, flexShrink: 0, color: '#1a6efc',
                    background: 'linear-gradient(135deg, #e8f0fe, #ddeaf9)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    border: '1px solid rgba(26,110,252,0.12)',
                  }}><item.icon size={19} /></div>
                  <div>
            ...
            {services.map((s, i) => (
              <div key={s.title}
                ...
                style={{
                  ...
                  borderRadius: 16, padding: '30px 24px', cursor: 'pointer',
              ...
              >
                <div style={{
                  width: 52, height: 52, borderRadius: 12, marginBottom: 16, color: '#1a6efc',
                  background: 'linear-gradient(135deg, #e8f0fe, #ddeaf9)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  border: '1px solid rgba(26,110,252,0.1)',
                }}><s.icon size={24} /></div>
        ...
        <div style={{ position: 'relative', maxWidth: 600, margin: '0 auto' }}
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="https://wa.me/923329555307" target="_blank" rel="noopener noreferrer" style={{
              ...
              color: 'white', padding: '13px 30px', borderRadius: 12,
