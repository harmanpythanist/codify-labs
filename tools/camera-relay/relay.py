...
own PC on the same network as the camera. The website talks to it over
localhost. The frames never leave your machine.
...
Listens on 127.0.0.1:8477 by default -- local only, not reachable from the
network. See --help for options.
"""
